        ...
        if (this.settings.closeable || this.settings.buttons.length) {
            ...
            if (this.settings.buttons.length) {
                for (let i = 0; i < this.settings.buttons.length; i++) {
                    ...
                    for (let k = 0; k < ((_j = (_h = this.settings.buttons[i]) === null || _h === void 0 ? void 0 : _h.classes) === null || _j === void 0 ? void 0 : _j.length); k++) {
                        button.classList.add(this.settings.buttons[i].classes[k]);
                    }
                    if ((_k = this.settings.buttons[i]) === null || _k === void 0 ? void 0 : _k.ariaLabel) {
...
class Notifier {
    ...
    loop() {
        ...
        if (document.hasFocus()) {
            for (let i = this.toaster.length - 1; i >= 0; i--) {
                if (((_a = this.toaster[i]) === null || _a === void 0 ? void 0 : _a.duration) &&
            ...
            if (this.snackbarQueue.length) {
                ...
                if (((_c = this.snackbarQueue[0]) === null || _c === void 0 ? void 0 : _c.duration) &&
    ...
    snackbar(settings) {
        ...
        const snackbar = {};
        if (!(settings === null || settings === void 0 ? void 0 : settings.message) ||
        ...
        if (typeof (settings === null || settings === void 0 ? void 0 : settings.duration) === "number" ||
        ...
        if (typeof (settings === null || settings === void 0 ? void 0 : settings.closeable) !== "undefined" &&
        ...
        if (typeof (settings === null || settings === void 0 ? void 0 : settings.force) !== "undefined" &&
        ...
        for (let i = 0; i < snackbar.buttons.length; i++) {
            ...
            if (!((_e = snackbar.buttons[i]) === null || _e === void 0 ? void 0 : _e.label) ||
    ...
    toast(settings) {
        ...
        else if (!(settings === null || settings === void 0 ? void 0 : settings.title) ||
