                        ...
                        <table>
                            <tbody>
                                ${this.state.creatures.map((creature, index) => {
                                    return html`
                                        <tr>
                                            <td data-creature="${creature.index}">${creature.name}</td>
                                            <td aria-label="View ${creature.name}" tooltip>
                                                <button data-creature="${creature.index}">
                                            ...
                                            <td aria-label="Delete ${creature.name}" tooltip>
                                                <button data-creature="${creature.index}" data-index="${index}" @click=${this.deleteCreature}>
