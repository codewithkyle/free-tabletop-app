...
class CreatureManager{
    ...
    private addCreature(creature:Creature){
        this.db.put("creatures", {
            ...
            speed: creature?.speed ? creature.speed : "—",
            str: creature?.str ?? 10,
            dex: creature?.dex ?? 10,
            con: creature?.con ?? 10,
            int: creature?.int ?? 10,
            wis: creature?.wis ?? 10,
            cha: creature?.cha ?? 10,
            vulnerabilities: creature?.vulnerabilities ? creature.vulnerabilities : "—",
            resistances: creature?.resistances ? creature.resistances : "—",
            immunities: creature?.immunities ? creature.immunities : "—",
            senses: creature?.senses ? creature.senses : "—",
            savingThrows: creature?.savingThrows ? creature.savingThrows : "—",
            skills: creature?.skills ? creature.skills : "—",
